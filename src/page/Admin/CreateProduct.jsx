...
import CloneProductModal from '../../modal/CloneProductModal';
...
function CreateProduct() {
  ...
  const columns = [
    ...
    {
      title: 'Update',
      render: (item) => <UpdateProductModal item={item}></UpdateProductModal>,
      className: 'table-cell-center'
    },
    {
      title: 'Clone',
      render: (item) => <CloneProductModal item={item}></CloneProductModal>,
      className: 'table-cell-center'
    },
    {
      title: 'Sale',
    ...
    {
      title: 'Delete',
      render: (item) => <DeleteProductModal item={item}></DeleteProductModal>,
      className: 'table-cell-center'
    },
  ];
